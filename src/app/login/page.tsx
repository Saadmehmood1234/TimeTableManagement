...
<form onSubmit={loginHandler} className="flex flex-col gap-2  items-center">
    ...
    <div className="flex flex-col gap-1">
        ...
        <input type="email"  placeholder="eg. kamlesh@gmail.com" name="email" className="w-[400px] h-[35px] rounded outline-none pl-4" value={email} onChange={(e)=>setEmail(e.target.value)}/>
    </div>

    <div className="flex flex-col gap-1">
        <p className="font-semibold text-[#4d4d4d]">Entet the Password</p>
        <input type="password" className="w-[400px] h-[35px] rounded outline-none pl-4" name="password" placeholder="eg. ****@**"  value={password} onChange={(e)=>setPassword(e.target.value)}/>
    </div>
